...
const fallbackVillages: VillageItem[] = [
  { name: "峰林小镇", location: "英德市", image: "mountain", rating: 4.8, tags: ["喀斯特峰林", "田园风光", "温泉度假"], description: "英西峰林走廊核心区，千座石灰岩峰林环绕，田园牧歌式乡村体验。", highlights: { rai: 92, cpi: 78, vsi: 95 }, season: "四季皆宜" },
  { name: "南岗千年瑶寨", location: "连南瑶族自治县", image: "landmark", rating: 4.9, tags: ["瑶族文化", "非遗传承", "古建筑群"], description: "全国规模最大的瑶族古寨，千年排瑶历史，长鼓舞、耍歌堂等国家级非遗活态传承地。", highlights: { rai: 75, cpi: 98, vsi: 88 }, season: "盘王节(农历十月)" },
  { name: "上岳古村", location: "佛冈县", image: "home", rating: 4.6, tags: ["广府古村", "锅耳墙", "宗祠文化"], description: "保存最完整的广府古村落之一，始建于南宋，拥有独特锅耳墙建筑群和深厚宗祠文化。", highlights: { rai: 88, cpi: 85, vsi: 92 }, season: "春秋最佳" },
  { name: "油岭瑶寨", location: "连南瑶族自治县", image: "theater", rating: 4.7, tags: ["瑶族歌舞", "耍歌堂", "原生态"], description: "「中国瑶族第一寨」，耍歌堂发源地，保留最原生态的排瑶生活方式与歌舞传统。", highlights: { rai: 68, cpi: 96, vsi: 82 }, season: "开耕节(农历三月)" },
  { name: "积庆里", location: "英德市", image: "leaf", rating: 4.5, tags: ["红茶文化", "茶园观光", "客家风情"], description: "英德红茶核心产区，百年茶文化传承地，集茶园观光、客家民俗、生态休闲于一体。", highlights: { rai: 90, cpi: 72, vsi: 94 }, season: "采茶季(3-5月)" },
];
