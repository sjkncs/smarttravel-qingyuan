...
import { MapPin, Brain, Mountain, Compass, Sparkles, Users, MessageSquare, CreditCard, Trophy, LogIn, UserPlus, User, Smartphone } from "lucide-react";
...
export default function NavBar() {
  ...
  const dropdownItems = [
    ...
    { icon: Smartphone, href: "/miniprogram", title: locale === "zh" ? "微信小程序" : "Mini Program", desc: locale === "zh" ? "扫码即用，指尖上的清远乡村之旅" : "Scan to use, Qingyuan travel at your fingertips" },
